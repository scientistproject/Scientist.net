...
namespace GitHub.Internals
{
    public static class ExperimentExtensions
    {
        ...
        public static Experiment<T> Where<T>(this ExperimentAsync<T> experiment, Func<Task<bool>> block)
        {
            experiment.RunIf = block;
            return experiment;
        }

        public static Experiment<T> Use<T>(this ExperimentAsync<T> experiment, Func<Task<T>> control)
        {
        ...
        public static Experiment<T> Try<T>(this ExperimentAsync<T> experiment, Func<Task<T>> candidate)
        {
        ...
        public static Experiment<T> BeforeRun<T>(this ExperimentAsync<T> experiment, Func<Task> action)
        {
