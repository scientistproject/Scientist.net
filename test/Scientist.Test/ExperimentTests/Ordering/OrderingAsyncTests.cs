...
public class OrderingAsyncTests
{
    [Fact]
    public async Task No_custom_ordering_specified_should_run_using_default_random()
    {
    ...
    [Fact]
    public async Task ControlFirst_specified_should_run_first()
    {
        var mock = Substitute.For<IControlCandidateTask<int>>();
        mock.Control().Returns(42);
        mock.Candidate().Returns(42);
    ...
    [Fact]
    public async Task ControlLast_specified_should_run_last()
    {
        var mock = Substitute.For<IControlCandidateTask<int>>();
        mock.Control().Returns(42);
        mock.Candidate().Returns(42);
    ...
    [Fact]
    public async Task Passed_custom_ordering_method_runs()
    {
        var mock = Substitute.For<IControlCandidateTask<int>>();
        mock.Control().Returns(42);
        mock.Candidate().Returns(42);
